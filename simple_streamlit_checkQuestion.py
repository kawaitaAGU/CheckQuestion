...
問題文と選択肢と正解答で校正されています。
選択肢は通常は５個ですが、それ以上の場合もあります。
場合によっては問題の説明が附属している場合もあります。その場合、問題を説明する説明文として妥当か結果だけ報告してください。
...
4. 画像の中の問題はかなりの確率で間違っているので、記述されている正解答を正しいとは忖度しないで。回答は無視してGPTが回答を出して。一致したらOK。違ったら、必ず報告して。
各問題ごとに見やすく整理して出力してください。報告全体は把握しやすいようにシンプルにして。"""
                        },
                        {
                            "type": "image_url",
                            "image_url": {
