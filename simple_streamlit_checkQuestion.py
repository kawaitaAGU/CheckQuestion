...
正解答、あるいは解答、回答は選択肢の後、解説の前に明示されています。例えば、14は１と4が正解の意味です。他の数字に惑わされないようにしてください。
正解番号の読み取りに注意してください。正解は「解答：」あるいは「正解：」のあとに数字で書かれていますが、それが問題番号ではないことを明確に理解して扱ってください。
正解答は特に正確に読み取ってください。まず正解、正解答、解答、回答と書かれている部分を判断して、正解答と記憶してから、後の処理に入りましょう。
